...
const Footer = () => {
  ...
  const openMail = (e?: React.MouseEvent) => {
    ...
    try {
      // Try top-level navigation first (most reliable)
      window.location.assign(MAILTO);
    } catch {
      // Fallback: synthesize an <a> click (helps inside intercepting wrappers)
          ...
          <div>
            ...
            <div className="space-y-3 mb-8">
              ...
              <div className="flex items-center">
                ...
                {/* keep href for right-click/save, but force open via JS */}
                <a
                  href={MAILTO}
                  target="_top"
                  onClick={openMail}
            ...
            <div className="pt-2">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                {/* Email button (use <button> to avoid any anchor interception) */}
                <button
                  type="button"
                  onClick={openMail}
