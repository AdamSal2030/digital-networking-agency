  ...
  return (
    <section className="proof-section">
      ...
      <div className="proof-grid">
        ...
        <a
          href="https://www.usatoday.com/story/special/contributor-content/2024/12/17/how-smart-air-technology-is-modernizing-air-conditioning/77054371007/"
          className="pc pc-corner-logo reveal"
        ...
        >
          <div className="pc-bar" />
          <div className="po">USA Today</div>
          <div className="ph">How Smart Air Technology Is Modernizing Air Conditioning</div>
          <div className="pm">December 17, 2024</div>
          <img
            src="/USA-Today-removebg-preview.png"
            alt="USA Today"
            className="pc-outlet-logo pc-outlet-logo--white"
          />
        </a>
