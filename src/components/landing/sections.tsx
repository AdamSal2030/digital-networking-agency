        ...
        <div style={{ maxWidth: "1300px", margin: "0 auto" }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                <a href="mailto:sam@digitalnetworkingagency.com" style={{ display: "flex", alignItems: "center", gap: "14px", color: "#aaa", fontSize: "15px", textDecoration: "none" }}
                  onMouseEnter={e => (e.currentTarget.style.color = "#ccff00")} onMouseLeave={e => (e.currentTarget.style.color = "#aaa")}>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                ...
                <a href="https://onboarding.digitalnetworkingagency.com" target="_blank" rel="noopener noreferrer"
                  ...
                  onMouseEnter={e => { e.currentTarget.style.background = "#ccff00"; e.currentTarget.style.color = "#111"; }}
          ...
          <div style={{ borderTop: "1px solid #1a1a1a", paddingTop: "1.5rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "0.75rem" }}>
            ...
            <div style={{ display: "flex", gap: "1.5rem" }}>
              <a href="https://onboarding.digitalnetworkingagency.com" style={{ color: "#444", fontSize: "13px", textDecoration: "none" }}
                onMouseEnter={e => (e.currentTarget.style.color = "#ccff00")} onMouseLeave={e => (e.currentTarget.style.color = "#444")}>Terms & Conditions</a>
              <a href="mailto:sam@digitalnetworkingagency.com" style={{ color: "#444", fontSize: "13px", textDecoration: "none" }}
                onMouseEnter={e => (e.currentTarget.style.color = "#ccff00")} onMouseLeave={e => (e.currentTarget.style.color = "#444")}>Privacy Policy</a>
            </div>
          </div>
        </div>
      </footer>
