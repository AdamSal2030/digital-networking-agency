            ...
            >
              <div className="bg-gray-800 rounded-2xl p-8 border border-gray-600">
                ...
                <p className="text-lg text-gray-300 leading-relaxed">
                  ...
                  <strong className="text-gray-100">elevate</strong> your presence and amplify your distinct voice in a{" "}
                  <strong className="text-gray-100">competitive</strong> landscape. We cultivate meaningful connections and{" "}
                  <strong className="text-gray-100">long-term success</strong>, empowering you to lead with confidence,
                  creativity, and{" "}
                  <strong className="text-gray-100">forward-thinking innovation</strong>.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-gray-800 rounded-2xl p-8 border border-gray-600">
                ...
                <p className="text-lg text-gray-300 leading-relaxed">
                  Our goal is to{" "}
                  <strong className="text-gray-100">redefine</strong> how stories are shared and recognized in today's{" "}
                  <strong className="text-gray-100">evolving media</strong> landscape. We prioritize authentic engagement and foster meaningful, high-impact{" "}
                  <strong className="text-gray-100">connections that resonate</strong> deeply with diverse{" "}
                  <strong className="text-gray-100">audiences worldwide</strong>. By remaining committed to these core
                  values, we consistently deliver outstanding results that elevate our clients'{" "}
                  <strong className="text-gray-100">presence</strong> and{" "}
                  <strong className="text-gray-100">influence</strong>.
                </p>
              </div>
            </div>
          </div>
